...
import (
	...
	"github.com/leandropiassetta/goexpert/9-apis/internal/entity/user"
...
func (u *UserMock) NewUser(name, email, password string) (user.User, error) {
...
func Test_NewUser(t *testing.T) {
	...
	t.Run("should return an error if password is too long", func(t *testing.T) {
		userMock.On("NewUser", "Leandro", "leandro@gmail.com", "senha_muito_longa_que_vai_ultrapassar_o_limite_de_72_caracteres_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx").Return(user.User{}, errors.New("password is too long"))
...
func Test_User_Other_Way(t *testing.T) {
	user, err := user.NewUser("Leandro", "l@gmail.com", "123456")
